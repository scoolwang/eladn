        ...
        <el-card class="box-card">
          <div style="min-height:165px;">
            <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="企业签名" name="first">
                <el-upload
                  ...
                  <div class="el-upload__text" style="background: #EDF1F7;height: 100%;">
                    ...
                    <div style="color:#000000;line-height: 26px;">上传待签名的IPA</div>
                    <div style="color:#999999;font-size: 12px;line-height: 22px;">可拖拽到此处上传</div>
                    <div>
                      <el-button class="upload-item" type="primary" style="margin: 5px;">
                        <span>立即上传</span>
                      </el-button>
                    </div>
                  </div>
            ...
            <el-row :gutter="20">
              <el-col :xs="12" :sm="12" :lg="12">
                <div class="text-center" style="height:160px;background: #5568A7;color:#ffffff;">
                  <span style="padding: 30px 0 30px;display: block;">剩余可用余额</span>
                  <span style="font-size: 40px;display: block;">1000.00</span>
                </div>
              </el-col>
              <el-col :xs="12" :sm="12" :lg="12">
        ...
        <el-card class="box-card">
          ...
          <div>
            ...
            <el-table
              ...
              <el-table-column :label="$t('table.bundleid')" width="140" align="left">
                <template slot-scope="scope">
              ...
              <el-table-column :label="$t('table.link')" width="124" align="left">
                <template slot-scope="scope">
                  <span style="text-decoration: underline;">qqqqq.com</span>
                </template>
              </el-table-column>
              <el-table-column :label="$t('table.actions')" align="left" class-name="fixed-width">
                <template slot-scope="scope">
