              ...
              <el-tab-pane label="应用分发" name="first">
                <el-upload
                  ...
                  <div class="el-upload__text" style="background: #EDF1F7;height: 100%;">
                    ...
                    <div style="color:#000000;line-height: 26px;">这处描述最多显示一行，内容内容内容内容…</div>
                    <div style="color:#999999;font-size: 12px;line-height: 22px;">可拖拽到此处上传，大小限制200MB以内</div>
                    <div>
            ...
            <el-row :gutter="20">
              <el-col :xs="12" :sm="12" :lg="12">
                <div class="text-center" style="height:160px;background: #5568A7;color:#ffffff;">
                  <span style="padding: 30px 0 30px;display: block;">剩余下载点数</span>
                  <span style="font-size: 40px;display: block;">1000</span>
                </div>
              </el-col>
              <el-col :xs="12" :sm="12" :lg="12">
                <div class="text-center" style="height:160px;background: #32BEA3;color:#ffffff;">
                  <span style="padding: 30px 0 30px;display: block;">付费下载点数</span>
                  <span style="font-size: 40px;display: block;">100</span>
                </div>
              </el-col>
            </el-row>
          </div>
        ...
        <el-card class="box-card">
          ...
          <div>
            ...
            <el-table
              ...
              <el-table-column :label="$t('table.bundleid')" width="140">
                <template slot-scope="scope">
              ...
              <el-table-column :label="$t('table.uploadtime')" width="124">
                <template slot-scope="scope">
                  <span>{{ scope.row.timestamp | parseTime('{m}/{d} {h}:{i}') }}</span>
                </template>
              </el-table-column>
              <el-table-column :label="$t('table.updatetime')" width="124">
                <template slot-scope="scope">
                  <span>{{ scope.row.timestamp | parseTime('{m}/{d} {h}:{i}') }}</span>
                </template>
              </el-table-column>
              <el-table-column :label="$t('table.link')" width="124">
                <template slot-scope="scope">
                  <span style="text-decoration: underline;">qqqqq.com</span>
                </template>
              </el-table-column>
              <el-table-column :label="$t('table.qrcode')" width="78" align="center">
                <template slot-scope="scope">
                  <el-popover
                    ...
                    width="150"
                    trigger="hover">
                    <img src="@/assets/vue/momo1.png" width="144px" height="144px">
                    <img slot="reference" src="@/assets/vue/momo1.png" width="44px" height="44px">
                  </el-popover>
                </template>
              </el-table-column>
              <el-table-column :label="$t('table.actions')" class-name="fixed-width">
                <template slot-scope="scope">
